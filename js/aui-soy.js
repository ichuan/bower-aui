/*! AUI Flat Pack - version 5.2.1-m1 - generated 2013-08-06 16:11:12 +1000 */
...
if(typeof aui=="undefined"){var aui={}}if(typeof aui.progressTracker=="undefined"){aui.progressTracker={}}aui.progressTracker.progressTracker=function(g,f,i){var b=f||new soy.StringBuilder();b.append("<ol",(g.id)?' id="'+soy.$$escapeHtml(g.id)+'"':"",' class="aui-progress-tracker',(g.isInverted)?" aui-progress-tracker-inverted":"");aui.renderExtraClasses(g,b,i);b.append('"');aui.renderExtraAttributes(g,b,i);b.append(">");var m=new soy.StringBuilder();var d=g.steps;var l=d.length;for(var e=0;e<l;e++){var c=d[e];if(c.isCurrent){var h=g.steps;var a=h.length;for(var j=0;j<a;j++){var k=h[j];aui.progressTracker.step(soy.$$augmentData(k,{width:Math.round(100/g.steps.length*10000)/10000,href:j<e?k.href:null}),m,i)}}}aui.progressTracker.content({steps:g.steps,content:m.toString()},b,i);b.append("</ol>");return f?"":b.toString()};aui.progressTracker.content=function(a,h,e){var c=h||new soy.StringBuilder();if(a.content!=""){c.append(a.content)}else{var g=a.steps;var b=g.length;for(var d=0;d<b;d++){var f=g[d];aui.progressTracker.step(soy.$$augmentData(f,{isCurrent:d==0,width:Math.round(100/a.steps.length*10000)/10000,href:null}),c,e)}}return h?"":c.toString()};aui.progressTracker.step=function(a,d,c){var b=d||new soy.StringBuilder();b.append("<li",(a.id)?' id="'+soy.$$escapeHtml(a.id)+'"':"",' class="aui-progress-tracker-step',(a.isCurrent)?" aui-progress-tracker-step-current":"");aui.renderExtraClasses(a,b,c);b.append('" style="width: ',soy.$$escapeHtml(a.width),'%;"');aui.renderExtraAttributes(a,b,c);b.append("><",soy.$$escapeHtml(a.href?"a":"span"),(a.href)?' href="'+soy.$$escapeHtml(a.href)+'"':"",">",soy.$$escapeHtml(a.text),"</",soy.$$escapeHtml(a.href?"a":"span"),"></li>");return d?"":b.toString()};
